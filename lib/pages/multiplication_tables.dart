...
class MultiplicationTables extends StatefulWidget {
  const MultiplicationTables({Key? key}) : super(key: key);

  @override
  State<MultiplicationTables> createState() => _MultiplicationTablesState();
}

class _MultiplicationTablesState extends State<MultiplicationTables> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                Text(
                  'Please select the number from the drop-down below to generate its multiplication table',
